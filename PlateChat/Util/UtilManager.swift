...
class UtilManager {
    ...
    // 画像のリサイズ
    open static func getResizeImage(_ image:UIImage, resize:CGSize) -> UIImage {
    ...
    /*
     画像を合成するクラスメソッド.
     */
    open static func ComposeUIImage(UIImageArray : [UIImage], width: CGFloat, height : CGFloat)->UIImage!{
